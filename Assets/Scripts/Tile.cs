...
public sealed class Tile : MonoBehaviour
{
    ...
    private void Start() => button.onClick.AddListener( () => Board.Instance.Select(this)); //When game starts add listener (method activation by condition) to board buttons
